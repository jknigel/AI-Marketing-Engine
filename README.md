...
Your AI marketing department, in a box: **31 Hermes agent profiles** covering every
marketing capability, **Opencode CLI** for anything that needs code built,
...
| Piece                     | Role                                                                                                                                                                                                                    |
| ------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `profiles/*.profile.md` | 31 capability profiles. Frontmatter = manifest (tools, required keys, schedule); body = the agent's SOUL. Materialized into Hermes-native`HERMES_HOME` dirs at setup.                                                 |
